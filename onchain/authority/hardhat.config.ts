...
const config: HardhatUserConfig = {
    networks: {
        hardhat: { accounts: { mnemonic: DEFAULT_DEVNET_MNEMONIC } },
        localhost: {
            url: process.env.RPC_URL || "http://localhost:8545",
            accounts: { mnemonic: DEFAULT_DEVNET_MNEMONIC },
        },
    ...
    external: {
        ...
        deployments: {
            ...
            goerli: [
                ...
                ppath("@cartesi/rollups", "/deployments/goerli"),
            ],
            sepolia: [
            ...
            polygon_mumbai: [
                ...
                ppath("@cartesi/rollups", "/deployments/polygon_mumbai"),
            ],
            arbitrum_goerli: [
                ppath("@cartesi/util", "/deployments/arbitrum_goerli"),
                ppath("@cartesi/rollups", "/deployments/arbitrum_goerli"),
            ],
            optimism_goerli: [
                ppath("@cartesi/util", "/deployments/optimism_goerli"),
                ppath("@cartesi/rollups", "/deployments/optimism_goerli"),
            ],
            bsc_testnet: [
                ppath("@cartesi/util", "/deployments/bsc_testnet"),
                ppath("@cartesi/rollups", "/deployments/bsc_testnet"),
            ],
            iotex_testnet: [
                ppath("@cartesi/util", "/deployments/iotex_testnet"),
                ppath("@cartesi/rollups", "/deployments/iotex_testnet"),
            ],
            chiado: [
                ppath("@cartesi/util", "/deployments/chiado"),
                ppath("@cartesi/rollups", "/deployments/chiado"),
            ],
        },
    },
    namedAccounts: {
